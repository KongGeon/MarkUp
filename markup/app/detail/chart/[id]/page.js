...
myChart03.setOption(option03);
    ...
    },
    {
      ...
      <div class="s__row">
          ...
          <!-- 선차트 -->
          <h1>선차트</h1>
          <div style="width: 800px;height:150px;"><canvas id="myChart01"></canvas></div>
          <div id="legend-container01"></div>

          <!-- 도넛차트 -->
          <h1>도넛차트</h1>
          <div style="width: 800px;height:250px;"><canvas id="myChart02"></canvas></div>
          <div id="legend-container02"></div>

          <!-- 바차트 -->
          <h1>바차트</h1>
          <div style="width: 800px;height:250px;"><canvas id="myChart03"></canvas></div>
      </div>
  </div>
      `,
      css: `
