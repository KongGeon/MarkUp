        ...
        <Row>
          ...
          <DeviceBtns>
            <DeviceBtn onClick={()=>setSize('size-mobile')}>
              <img src={size === 'size-mobile' ? "/icon_mobile_on.svg" : "/icon_mobile.svg" } alt="모바일사이즈" />
            </DeviceBtn>
            <DeviceBtn onClick={()=>setSize('size-tablet')}>
              <img src={size === 'size-tablet' ? "/icon_tablet_on.svg" : "/icon_tablet.svg" } alt="태블릿사이즈" />
            </DeviceBtn>
            <DeviceBtn onClick={()=>setSize('size-pc')}>
              <img src={size === 'size-pc' ? "/icon_pc_on.svg" : "/icon_pc.svg" } alt="PC사이즈" />
            </DeviceBtn>
          </DeviceBtns>
        </Row>
      </Container>
